...
const SEKCJE = [
  ...
  },
  {
    ...
    akapity: [
      ...
      '<code>q</code>/<code>e</code> to krok po skosie do przodu-w-lewo/w-prawo, a <code>z</code>/<code>c</code> to krok po skosie do tyłu-w-lewo/w-prawo - postać się przy nich NIE obraca, zostaje zwrócona tak jak przed krokiem.',
      'Kombinacje: <code>ww</code> = 2 pola do przodu, <code>wd</code> = przód i w prawo, <code>wq</code> = przód i skos w lewo, dowolne złożenie <code>w</code>/<code>a</code>/<code>s</code>/<code>d</code>/<code>q</code>/<code>e</code>/<code>z</code>/<code>c</code>, maks. 5 liter.',
